...
PLAYER.MENU_URL = "midi/midiMenu.json";
...
PLAYER.loadMenu = function(url)
{
    report("LoadCompositions "+url);
    $.getJSON(url, function(obj) { PLAYER.menuLoaded(obj) });
}

PLAYER.loadCompositions = function(url)
{
    report("**** please use loadMenu instead of loadCompositions ***");
    PLAYER.loadMenu(url);
}

PLAYER.menuLoaded = function(obj)
{
...
$(document).ready( function() {
    PLAYER.setupTrackInfo();
    PLAYER.loadMenu(PLAYER.MENU_URL);
});
